        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full">
          ...
          <div className="w-1/2 px-6">
            ...
            <p className="text-xl">
              ...
              of its members. It provides students with opportunities to
              engage in industrial projects, workshops, and competitions that
              develop their knowledge in the field.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="w-1/2 px-6">
          ...
          <p className="text-xl">
            ...
            of our esteemed alumni to help budding engineers. Regular
            workshops, guest lectures, and industrial visits are organized to
