    ...
    return (
        <div className="relative w-full h-screen flex flex-col sm:justify-around md:flex-row items-center text-white bg-cover bg-center px-6" 
            ...
            <div className="relative z-10 md:w-2/5 text-center md:text-left flex flex-col items-center md:items-start space-y-4 sm:pt-4">
                <h3 className="text-lg md:text-xl text-yellow-300 font-merriweather">Welcome to Annual</h3>
                ...
                <div className="mt-6">
                    <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg text-lg">Explore</button>
                </div>
            </div>

            {/* Right Section */}
            <div className="relative z-10 flex flex-col items-center md:w-2/5 space-y-6">
                <div className="relative flex flex-col items-center" style={{ width: "clamp(300px, 50vw, 500px)" }}>
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <p className="text-[clamp(1rem,3vw,2rem)] text-yellow-300 drop-shadow-lg font-modern">Whispers of Time</p>
                    </div>
                    <Image src="/images/book.png" alt="Open book" width={500} height={400} className="w-full" />
                </div>
            </div>
        </div>
    );
