...
export default function ExploreSection() {
  return (
    <div className="relative w-full h-screen flex flex-col items-center justify-center text-white bg-cover bg-center px-6 text-center" style={{ backgroundImage: "url('images/pngtree.png')" }}>
